...
def load_tweets(corpus_dir):
    ...
    pos_tweets = load_corpus(corpus_dir + 'aldayel_pos_test.txt', sep=False)
    neg_tweets = load_corpus(corpus_dir + 'aldayel_neg_test.txt', sep=False)
...
if __name__ == '__main__':
    ...
    for method in methods:
        ...
        corpus = load_tweets(corpus_dir='./corpus_Aldayel/split/')
