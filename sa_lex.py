...
def load_tweets(corpus_dir):
    ...
    pos_tweets = load_corpus(corpus_dir + 'tweets_pos_test.txt', sep=False)
    neg_tweets = load_corpus(corpus_dir + 'tweets_neg_test.txt', sep=False)
...
if __name__ == '__main__':
    ...
    do_sa_lex(corpus_dir='./corpus_v4/split/', method='base')
