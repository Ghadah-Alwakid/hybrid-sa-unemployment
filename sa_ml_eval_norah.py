...
def load():
    pos_train_file = 'corpus_nora/corpus/PosTrain.txt'
    neg_train_file = 'corpus_nora/corpus/NegTrain.txt'

    pos_test_file = 'corpus_nora/corpus/PosTest.txt'
    neg_test_file = 'corpus_nora/corpus/NegTest.txt'
