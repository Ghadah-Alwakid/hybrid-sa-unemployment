...
def load():
    pos_train_file = 'corpus_v4/split_light/tweets_pos_train.txt'
    neg_train_file = 'corpus_v4/split_light/tweets_neg_train.txt'

    pos_test_file = 'corpus_v4/split_light/tweets_pos_test.txt'
    neg_test_file = 'corpus_v4/split_light/tweets_neg_test.txt'
