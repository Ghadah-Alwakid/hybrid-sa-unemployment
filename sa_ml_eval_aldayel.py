...
def load():
    pos_train_file = 'corpus_Aldayel/split/aldayel_pos_train.txt'
    neg_train_file = 'corpus_Aldayel/split/aldayel_neg_train.txt'

    pos_test_file = 'corpus_Aldayel/split/aldayel_pos_test.txt'
    neg_test_file = 'corpus_Aldayel/split/aldayel_neg_test.txt'
